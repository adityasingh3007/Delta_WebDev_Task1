...
function Create_mentee(m_name,m_dob,m_age,m_profile,m_rating) {
	this.name=m_name;
	this.dob=m_dob;
	this.age=m_age;
	...
	this.ret_age=function() {
				return this.age;
			}
	this.ret_dob=function() {
				return this.dob;
			}
	this.ret_profile=function() {
				return this.profile;
			}
	this.ret_rating=function() {
				return this.rating;
			}
}
